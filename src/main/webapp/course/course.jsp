...
<div id="sidebar">
  ...
  <ul>
    ...
    <li class="submenu  ">
      <a href="#"><i class="icon icon-th"></i> <span>课程信息列表</span> </a>
      <ul>
        <li class="active"><a href="addcour.jsp">新增课程</a></li>
      </ul>
    </li>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tr>
                ...
                <th style="text-align: center;font-family:微软雅黑;"><h5>教员编号</h5></th>

                <th style="text-align: center;font-family:微软雅黑;"><h5>课程名称</h5></th>
              ...
              <td style="text-align: center;font-family:Consolas;"><strong><%=tb.getCourseName()%>
              </strong></td>




              <td style="text-align: center;font-family:Consolas;"> <a href="editcour.jsp?courseid=<%=
              tb.getCourseId()%>"/> 编辑 </a> </td>
              <td style="text-align: center;font-family:Consolas;"> <a href="javascript:deleteCour(<%=tb.getCourseId()%>)"/> 删除 </a> </td>
...
<script>
  ...
  function deleteCour(courseid) {

    var a = window.confirm("确定删除吗？");
    if (a == true) {
      location = '../tblcourdele?courseid='+ courseid;
    }
