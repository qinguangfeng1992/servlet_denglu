            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/tblscoadd" method="get" class="form-horizontal"/>
                     <%--   <div class="control-group">
                            <label class="control-label">分数编号</label>

                            <div class="controls">
                                <input type="text" name="pkScore " value="<%=tblscore .getPkScore()%>"/>
                            </div>
                        </div>--%>
                        <div class="control-group">
