...
<div id="sidebar">
  ...
  <ul>
    ...
    <li class="submenu active ">
      <a href="#"><i class="icon icon-th"></i> <span>分数信息列表</span> </a>
      <ul>
        <li class="active"><a href="addsco.jsp">新增分数</a></li>
      </ul>
    </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              <thead>
              <tr>
                <th style="text-align: center;font-family:微软雅黑;"><h5>分数编号</h5></th>
                <th style="text-align: center;font-family:微软雅黑;"><h5>学生编号</h5></th>
                <th style="text-align: center;font-family:微软雅黑;"><h5>课程编号</h5></th>

                <th style="text-align: center;font-family:微软雅黑;"><h5>分数</h5></th>
              ...
              <%
                for (Tblscore tb : list) {
              %>
              <tbody>
              <td style="text-align: center;font-family:Consolas;"><strong><%=tb.getPkScore()%>
              </strong></td>
              <td style="text-align: center;font-family:Consolas;"><strong><%=tb.getStuId()%>
              </strong></td>
              <td style="text-align: center;font-family:Consolas;"><strong><%=tb.getCourseId()%>
              </strong></td>
              <td style="text-align: center;font-family:Consolas;"><strong><%=tb.getScore()%>
              </strong></td>



              <td style="text-align: center;font-family:Consolas;"> <a href="/sco/editsco.jsp?pkscore=<%=
              tb.getPkScore()
              %>"/> 编辑 </a> </td>
              <td style="text-align: center;font-family:Consolas;"> <a href="javascript:deleteSco(<%=tb.getPkScore()%>)"/> 删除 </a> </td>
...
<script>
  ...
  function deleteSco(pkscore) {

    var a = window.confirm("确定删除吗？");
    if (a == true) {
      location = '../tblscodele?pkscore='+ pkscore;
    }
