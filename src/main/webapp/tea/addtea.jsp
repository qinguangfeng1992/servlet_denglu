...
<div id="sidebar">
    ...
    <ul>
        <li class="submenu active open">
            <a href="#"><i class="icon icon-th-list"></i> <span>教员信息列表</span> <span class="label">3</span></a>
            <ul>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="../tblteaadd" method="get" class="form-horizontal"/>
